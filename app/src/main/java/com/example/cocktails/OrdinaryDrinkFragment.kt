...
import com.example.cocktails.databinding.FragmentOrdinaryDrinkBinding
...
class OrdinaryDrinkFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentOrdinaryDrinkBinding.inflate(inflater, container, false)
        return binding.root
    }
        ...
        with(binding) {
            refreshLayout.setOnRefreshListener {
                ...
                var runnable = Runnable {
                    ...
                    val reposOrdinaryDrink = service.listOrdinaryDrink(API_KEY)
                    ...
                    reposOrdinaryDrink.enqueue(object : Callback<DrinkList> {
                        ...
                        override fun onResponse(
                            ...
                            if (response.isSuccessful) {
                                ...
                                recyclerView.adapter = response.body()?.let { RecyclerViewAdapter(it.drinks) }
